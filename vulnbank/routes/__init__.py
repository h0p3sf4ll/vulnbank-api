...
from vulnbank.routes.receipts import bp as receipts_bp
from vulnbank.routes.search import bp as search_bp
from vulnbank.routes.transfers import bp as transfers_bp
from vulnbank.routes.users import bp as users_bp


def register_blueprints(app: Flask) -> None:
    for bp in (auth_bp, users_bp, accounts_bp, transfers_bp, receipts_bp, messages_bp, admin_bp, search_bp):
